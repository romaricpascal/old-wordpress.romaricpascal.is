<div class="<?php echo $classes; ?>">
	...
	<p>Whether you need a full website built, or some target front-end (HTML/CSS/JavaScript) help, I&rsquo;ll be happy to chat about how I can help. <a href="mailto:<?= get_bloginfo('admin_email')?>">Get in touch</a>!</p>
</div>